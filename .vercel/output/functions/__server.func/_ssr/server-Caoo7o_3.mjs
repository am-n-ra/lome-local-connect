import "../_runtime.mjs";
import { a as RouterProvider, d as require_jsx_runtime, f as require_react, n as defineHandlerCallback, t as renderRouterToStream } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DFBDpOWB.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Cf4KIwKj.mjs"),
		import("./start-CiL2qh1a.mjs"),
