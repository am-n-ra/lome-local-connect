...
| AUTH-03 | Recreate only authorized demo Auth identities for live bearer proof | ROOT-001, ROOT-002 | `blocked` | [`v2-root-demo-recreation-decision.md`](./v2-root-demo-recreation-decision.md) records the confirmed two-demo scope, aggregate inventory and supported-capability review. Direct SQL would bypass the Auth lifecycle and no supported Neon Auth user-level delete/recreate or session-impersonation operation is available; existing demo fixtures were preserved |
