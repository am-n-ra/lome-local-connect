...
| ROOT-006 | Add audit events, correlation IDs and mutation idempotency | ROOT-001 | `partial` | 11 test files/47 tests pass, including redacted internal errors, typed malformed-input handling, availability replay-shape checks and Auth-linked conditional QR persistence checks; disposable-branch guard behavior and QR first-pass/second-pass results remain; database concurrency, audit append and live idempotency proof remain open |
