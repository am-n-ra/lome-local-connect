...
- Passage automatique à `confirmed` (3 transactions, 3 acheteurs distincts) avec bonus 10 000 FCFA + 2 mois Pro.(soyons clair le model economique est 5000f par mois pour activer le pro qui permet de lister plsu de 5 produits et plus d'une facilite aussi le montant de labonnement est ensuite utilisable comme budget comm mais non reutilisable pour rester en pro le mois qui suit dou les 10000 si non utiliser donnent 2 mois par defaut mais si la pub faite depasse 5000 des le mois qui suit le mois 1 il doit recharger pour completer ce qui reste dans les 10000 qui nest pas encore utilise par la pub pour que ca fasse au moins 5000 et pour acceder a pub il faut etre en pro....)  
  
J'ai remarquer que l'acces admin me laissait pbrievement acceder a la page avant de restreindre alors que ce ne devrait pas etre le cas cest sense etre lendroit le plus proteger de notre app... et meme cache.. peut etre juste accessible de linerieur dun compte admin..
