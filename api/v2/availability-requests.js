...
async function availabilityRequestsHandler(req, res) {
  const url = requestUrl(req, "/api/v2/availability-requests");
  await handleApi(req, res, "/api/v2/availability-requests", url);
}

// src/server/vercel/availability-requests.ts
var availability_requests_default = availabilityRequestsHandler;
export {
  availability_requests_default as default
};
