...
| Persistence and migration | Additive, namespaced and preservation-first | Read-only branch catalog reports 26 public `v2_` tables, 125 constraints and legacy public tables coexisting; migration 003 executed on expiring disposable branch and verified with 2 constraints, 7 triggers, QR function presence and representative ownership/scope/append-only behavior; production/default branch was untouched | `review` | Preserved-row comparison and rollback/recovery record |
