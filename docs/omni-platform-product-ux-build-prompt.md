...
- Keep the resting map populated with sparse, real, source-backed facility discovery points. Do not use a naked map or fake markers. Use a warm white/cream spatial field with soft desaturated blue-grey water and warm-white land; suppress country/city labels at default globe scale unless needed for the search reveal.
