...
| Bulk availability |​ 3 opérations groupées / mois( crédits( | **Crédits bulk Pro = base mensuelle ≈ 100/mois** ( ≈ 3 besoins/jour(, principe **1 besoin = 1 bulk**,  ​30 rejeté comme insuffisant(; chaque demande à plusieurs facilités consomme une quantité; surplus rachetable au-delà | **Quota absent** — aucune route de comptage bulk |
...
|---|---|---|---|---|
| P1 | Quotas bulk acheteur( 3 crédits/mois Free,, Pro = **base mensuelle ≈ 100 bulk/mois** ( à fixer(, 30 insuffisant(, consommables par demande multi-facilités( | Honnéteté des promesses acheteur| NW-13d comptage serveur de crédits + packs |
...
| D-G |Quotas bulk = crédits de volume: ​3 crédits/mois Free; **Pro = base mensuelle ≈ 100 crédits/mois**(à fixer, principe **1 besoin = 1 bulk**,  ​30 rejeté comme insuffisant(; chaque demande à N facilités consomme une quantité |**(a(: 3 crédits Free/mois** + **Pro base mensuelle ≈ 100/mois, consommables** + surplus rachetable en packs |
...
Spec validée fondateur 2026-09-10, **amendée fondateur 2026-09-11**; décisions D-E…D-K **verrouillées**; le modèle de revenus est **figé**: profondeur/largeur/fréquence/visibilité/intelligence; Free​ 5 produits; **catalogue vendeur ILLIMITÉ en Pro actif** ( autres produits visibles Omni que quand Pro actif(; 3 types de facilité; **bulk = crédits de volume: 3 crédits/mois Free, Pro = **base mensuelle ≈ 100 crédits/mois** ( 1 besoin =  ​1 bulk(,, 30 insuffisant(,, surplus rachetable au-delà(,, consommables par demande multi-facilités**; bonus​ 20 USD verrouillé après 3 ventes QR à users distincts; abonnement auto+opt-out;; slot​ 1 000 XOF à confirmer; acheteur Pro lancé maintenant.
...
| 2 | NW-13d | Crédits bulk serveur: 3 crédits/mois Free,, **Pro base mensuelle ≈  ​100 crédits/mois** ( 1 besoin =1 bulk(,, comptage par demande multi-facilités + packs surplus | D-G |
