...
| T-07a | T-07 | **Admin slice** — inventory + close gaps + prove | T-06 | `deployed` — **credential proof pending** | 039 applied 2026-09-03; push exécuté (routes 401, hash match, guardrail ✅); reste preuve admin avec identifiants fondateur (`scripts/prove-v2-admin.mjs`) puis T-07a `done` |
