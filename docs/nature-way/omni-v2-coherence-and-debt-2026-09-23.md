...
| COH-V2-15 | Visuelle | Faible | Écrans non encore audités en profondeur : `entite-publique`, `facility-apex`, `txn-room`, `produit-multi` | audit 2026-09-23 partiel | risque d'écart résiduel sur pages secondaires | audit au prochain tour | Nature Way | `watch` |
