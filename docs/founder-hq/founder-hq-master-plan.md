...
| G-02b | G-02 | Species / `/nature-way` | Admin/operator maquette set (roles, claim review, operator runs, audit) obeying R-01/R-02/R-03 | G-02a | Founder | `ready` (pending acceptance) | Accepted set (`docs/maquette/omni-admin-operator-maquette.html` + spec) | None existed before this pass | Founder revises R-01/02/03 or build order |
...
> **Where we are:** Milestone M-01; Gate 2 (Species) open; G-02a audit **done**; G-02b Admin/operator maquette set **ready for founder acceptance**; `/nature-way` active.  
...
> **What proves the next move:** Founder accepts the Admin/operator maquette set (G-02b) — `docs/maquette/omni-admin-operator-maquette.html` + spec `docs/nature-way/omni-admin-operator-maquette-set-G02b-2026-09-02.md` — against rules R-01 (bottom simple control panel), R-02 (simple/direct first visit), R-03 (map-contextual actions).  
