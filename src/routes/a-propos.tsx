          ...
          <div className="mx-auto grid max-w-6xl gap-10 px-4 py-16 md:grid-cols-2 md:items-center">
            <div>
              ...
              <p className="mt-4 text-muted-foreground">
                Vous demandez à vos proches, vous tapez au hasard sur Google, vous vous déplacez
                sans savoir si c'est encore disponible. La plupart du temps, vous finissez par
                acheter ailleurs, alors qu'une meilleure option était à deux rues.
              </p>
            ...
            <div className="omni-card p-4">
              ...
              <div className="mt-3 space-y-2">
                {[
                  ...
                  {
                    name: "Tech Store Lomé 2000",
                    dist: "1,8 km",
                    stock: "Disponible",
                    fresh: true,
                  },
                  {
                    name: "Moto-Pièces Express",
                    dist: "2,4 km",
                    stock: "En rupture",
                    fresh: false,
                  },
        ...
        <section className="border-y border-border bg-card">
          <div className="mx-auto max-w-6xl px-4 py-14 text-center">
            ...
            <blockquote className="mx-auto mt-10 max-w-2xl text-balance text-lg italic text-muted-foreground">
              « J'ai payé des panneaux toute une saison. Sur cent personnes, quatre sont venues.
              Ici, les gens arrivent en sachant déjà ce que j'ai en boutique. »
        ...
        <section className="mx-auto max-w-3xl px-4 py-16">
          ...
          <Accordion type="single" collapsible className="mt-6">
            <AccordionItem value="q1">
              <AccordionTrigger>
                Est-ce que c'est payant pour chercher un produit ?
              </AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="q3">
              <AccordionTrigger>
                Qu'est-ce que je peux faire avec les 10 000 FCFA ?
              </AccordionTrigger>
              <AccordionContent>
