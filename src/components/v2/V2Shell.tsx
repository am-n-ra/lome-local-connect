...
export function V2Shell() {
  ...
  const selectFacility = (facility: Facility) => { setSelected(facility); dispatch({ type: "select-facility", facilityId: facility.id, returnSurface: surface.active === "result" ? "result" : "map" }); };
